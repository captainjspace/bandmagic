      ...
      <body className="isolate relative bg-neutral-950 text-neutral-100 min-inline-screen font-mono antialiased">
        <PlayerProvider>
          <header className="border-b -z+10 border-neutral-800 px-6 py-4 flex items-center justify-between">
            <Link
              href="/"
              className="font-agincourt text-rbyellow-500 text-2xl sm:text-4xl md:text-feature-title leading-none tracking-wide"
            >
              Rolling Blackout
            </Link>
          ...
          <main className="max-w-5xl mx-auto z-[10] px-6 py-10 pb-24">
            {children}
          </main>
          <FooterPlayer />
        </PlayerProvider>
