...
const LINKS = [
  { href: '/track-group/new', title: '+ New Track Group', desc: 'Curate tracks, attach assets, notify the band.' },
  { href: '/', title: 'Track Groups', desc: 'Browse and edit existing track groups.' },
  { href: '/admin/assets', title: 'Assets', desc: 'Manage lyrics, chord charts, press, and reviews.' },
  { href: '/browse', title: 'Browse', desc: 'Inspect the GCS bucket backing the catalog.' },
];
  ...
  return (
    <div className="max-w-2xl">
      <div className="mb-6">
        ...
        <p className={`${colors.page.subtitle} text-sm mt-1`}>Link hub for managing track groups, tracks, and assets.</p>
      </div>
