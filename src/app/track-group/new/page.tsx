  ...
  return (
    <div className="max-w-2xl">
      <div className="mb-6 flex items-start justify-between">
        ...
        <Link href="/admin" className={`${colors.page.navLink} text-xs mt-1 transition-colors`}>← Admin</Link>
      </div>
      ...
      <form onSubmit={e => { e.preventDefault(); submit(true); }} className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            <p className={`text-xs ${colors.assets.label} mb-1.5`}>Track group assets (lyrics, press, etc. shared across the whole group)</p>
            <AssetPicker
