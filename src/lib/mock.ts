...
export const mockDriveFiles: DriveFile[] = (
  driveExport as { files: RawDriveFile[] }
).files.map((f) => ({
  id: f.id,
  name: f.name,
  mimeType: f.mimeType,
  ...
  owners: [
    {
      emailAddress: "joshgcp@rollingblackoutband.com",
      displayName: "Joshua Landman",
    },
  ],
}));
...
export const mockTrackGroups: TrackGroup[] = [
  {
    ...
    description:
      "13 tracks — rough cuts, demos, and jams from the current writing session.",
    createdAt: "2026-06-08T00:00:00Z",
    createdBy: "joshgcp@rollingblackoutband.com",
    assets: [
      {
        linkId: "mock-link-group-magicali-review",
        assetId: "mock-asset-review-magicali",
        addedAt: "2026-06-12T00:00:00Z",
        addedBy: "joshgcp@rollingblackoutband.com",
      },
    ],
    tracks: [
      {
        path: "2026/2025-01-15-DarkBox-NightAngel.mp3",
        title: "Dark Box Night Angel",
      },
      {
        path: "2026/MAGICAL.mp3",
        title: "Magical",
        assets: [
          {
            linkId: "mock-link-track-magical-lyrics",
            assetId: "mock-asset-lyrics-magical",
      ...
      {
        path: "2026/MagiCali.mp3",
        title: "MagiCali",
        assets: [
          {
            linkId: "mock-link-track-magicali-review",
            assetId: "mock-asset-review-magicali",
            addedAt: "2026-06-12T00:00:00Z",
            addedBy: "joshgcp@rollingblackoutband.com",
          },
      ...
      {
        path: "2026/StraightJazzCock-FakePurpleTele.mp3",
        title: "Straight Jazz Cock — Fake Purple Tele",
      },
