              ...
              return (
                ...
                >
                  ...
                  <button
                    type="button"
                    onClick={() => detach(id)}
                    className={`ml-1 ${colors.chip.remove}`}
                  >
                    ✕
                  </button>
                </span>
          ...
          <div className="absolute z-50 top-full mt-1 w-full bg-neutral-900 border border-neutral-700 rounded shadow-xl">
              ...
              <>
                ...
                {loadState === "loaded" && filtered.length === 0 && (
                  <div className={`px-3 py-2 text-sm ${colors.empty}`}>
                    {assets.length === 0
                      ? "No assets yet — create one to attach it."
                      : "No matches — try Create new."}
                  </div>
                )}
                {loadState === "loaded" && filtered.length > 0 && (
                        ...
                        <li key={asset.id}>
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              {elsewhere && (
                                <div className={`text-xs ${colors.rowHint}`}>
            ...
            {mode === "create" && (
              ...
              >
                ...
                {createSource === "drive" && (
                  <DriveSearch
                    onSelect={onDrivePick}
                    initialQuery={driveSeed}
